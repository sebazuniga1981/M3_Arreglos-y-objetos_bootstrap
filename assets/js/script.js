import propiedadesAlquiler from "./data/propiedadesAlquiler.js"
import propiedadesVenta from "./data/propiedadesVenta.js"

window.addEventListener("DOMContentLoaded", () => {
  if (document.getElementById("venta")) {
    renderizarPropiedades(propiedadesVenta, "venta", 3);
  }

  if (document.getElementById("alquiler")) {
    renderizarPropiedades(propiedadesAlquiler, "alquiler", 3);
  }
});
